...
| 3B | Baseline measurement | Baseline scorecard, all 15 scored + miss taxonomy, recorded | 🔌 | in progress: authoring + rendering the 15 cases with catalog + examples only (no AUTHORING.md recipes) |
