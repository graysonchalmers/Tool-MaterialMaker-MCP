...
_Last updated: 2026-09-14 (preview lighting rig overhauled -- soft distance shadows, shadow-casting kick rim, sky bounce, SSAO, precession-default sweep -- merged to `main` `6ce84c6`, not pushed; round 1+2 noise vocabulary and `render_preview_sweep` all merged earlier the same day)._
