...
|---|---|---|---|
| ![](images/s02_gray_granite.png) | Polished gray granite | "polished gray granite" | fine voronoi per-cell-random flecks (port 2) through a multi-tone gray ramp; real micro-relief via the `normal_map` `param4=0` fix |
...
| ![](images/m02_brushed_aluminum.png) | Brushed aluminum | "brushed aluminum" | straightened wood-grain clone: parallel directional streaks, forced metallic; real brush-scratch relief via the `normal_map` `param4=0` fix |
